...
export const routes: Routes = [
  ...
  { path: 'channels', canActivate: [authGuard, permissionGuard], data: { permission: 'channel.view' }, loadComponent: () => import('./features/channels/admin-channels-page').then(m => m.AdminChannelsPage), title: 'Quản lý kênh · HuTube' },
  { path: 'videos', canActivate: [authGuard, permissionGuard], data: { permission: 'video.view' }, loadComponent: () => import('./features/videos/admin-videos-page').then(m => m.AdminVideosPage), title: 'Quản lý video · HuTube' },
  ...
  { path: 'moderation/reports', canActivate: [authGuard, permissionGuard], data: { permission: 'report.view' }, loadComponent: () => import('./features/moderation/admin-reports-page').then(m => m.AdminReportsPage), title: 'Báo cáo vi phạm · HuTube' },
  { path: 'moderation/appeals', canActivate: [authGuard, permissionGuard], data: { permission: 'appeal.view' }, loadComponent: () => import('./features/moderation/admin-appeals-page').then(m => m.AdminAppealsPage), title: 'Khiếu nại kiểm duyệt · HuTube' },
